...
func init() {
	...
	flagOverwrite = flag.Bool("f", false, "Whether to proceed even if the output dir is not empty")
}
...
func main() {
	...
	cfg, err := config.NewConfig(rg, *flagOutputDir, *flagMappingFile, *flagPattern, *flagOverwrite)
	if err != nil {
		fatal(err)
	}
