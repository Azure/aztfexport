...
The Terraform configurations generated by `aztfy` are not meant to be comprehensive and do not ensure that the infrastructure can be fully reconstructed from the generated configurations. For details, please refer to the [limitation](#limitation).
